...
u[1][n_]'[t]:= u[2][n-1][t]*u[4][n][t]-u[2][n][t]*u[4][n+1][t];
u[2][n_]'[t]:= u[3][n-1][t]*u[4][n][t]-u[3][n][t]u[4][n+2][t];
u[3][n_]'[t]:= u[4][n+3][t]-u[4][n][t];
u[4][n_]'[t]:= u[4][n][t](u[1][n-1][t]-u[1][n][t]);

noeqs = 4;
name = "Blaszak-Marcinial2";
parameters = {};
weightpars = {};
