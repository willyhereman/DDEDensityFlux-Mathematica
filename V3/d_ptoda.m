...
(* Toda Lattice with parameters *)

u[1][n_]'[t]:= aa*u[2][n-1][t] - u[2][n][t]; 
u[2][n_]'[t]:= u[2][n][t]*(bb*u[1][n][t] - u[1][n+1][t]); 

noeqs = 2;
name = "Parametrized Toda Lattice";
parameters = {aa,bb};
weightpars = {};
...
(* user can give the weights of u[1], u[2] *)
(* weightu[1] = 1; weightu[2] = 2; *)

formrho = 0; 

(* user can give the form of rho. Here, for density of rank 3: *)
(* formrho = c[1]*u[1][n][t]^3+c[2]*u[1][n][t]*u[2][n-1][t]+
             c[3]*u[1][n][t]*u[2][n][t]; *)
